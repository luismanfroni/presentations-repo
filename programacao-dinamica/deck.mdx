...
- Sobre a Programação Dinâmica
- Visualização de nó de uma função recursiva sem otimização vs com otimização
...
import recursiveImg from "./recursive.png";

# Nó de uma função recursiva

<img src={recursiveImg} />

---

import recursiveOptImg from "./memo-recursive.png";

# Nó de uma função recursiva otimizada

<img src={recursiveOptImg} />
...
<div style={{ padding: '48px' }}>
  ...
  Tabulação: de baixo para cima (bottom-up).

  Memoização: de cima para baixo (up-bottom).
</div>
...
# Foi utilizado programação dinâmica no TCC?
...
import pathFinding from "./a-star.jpeg";
